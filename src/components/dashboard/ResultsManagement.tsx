...
import { validateCsvFile, formatFileSize } from '../../utils/fileValidation';
import { 
  Upload, 
  Download, 
  Plus, 
  ...
  const handleFileUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      if (!validation.valid) {
        ...
        // Optionally display the validation error (consider adding state to store errors)
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Accepted format: CSV files only. Maximum file size: 50MB.
                </p>
              </div>
              ...
              {csvFile && (
                <Alert>
                  ...
                  <AlertDescription>
                    File ready: {csvFile.name} ({formatFileSize(csvFile.size)})
                  </AlertDescription>
                </Alert>
              )}
