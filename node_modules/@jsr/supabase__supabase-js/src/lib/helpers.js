...
export function applySettingDefaults(options, defaults) {
  ...
  const result = {
    ...
    tracePropagation: {
      enabled: tracePropagationOptions?.enabled ?? DEFAULT_TRACE_PROPAGATION_OPTIONS?.enabled ?? false,
      respectSamplingDecision: tracePropagationOptions?.respectSamplingDecision ?? DEFAULT_TRACE_PROPAGATION_OPTIONS?.respectSamplingDecision ?? true
    },
    accessToken: async ()=>''
  };
